...
def button():
	...
	BUTTON+=[[InlineKeyboardButton(text="👨🏼‍💻Developer✨",url="https://t.me/SakirBey2")]]
...
async def _(client, message):
	...
	await message.reply_text(text="**Merhaba {}!**\n\n__Ben @sessizlerkurucu Tarafından Yapılan Doğruluk Cesaret Botuyum__\n\n**Repom =>** [Open](https://t.me/SakirBey2)\nDoğruluk mu? Cesaret mi? Oyun Komutu => /dc".format(
